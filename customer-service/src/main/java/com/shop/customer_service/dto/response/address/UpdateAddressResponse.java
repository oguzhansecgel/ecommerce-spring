...
public class UpdateAddressResponse {
    ...
    public UpdateAddressResponse(int id, String street, String buildingNumber, String apartmentNumber, String district, String city, String state, String country, String zipcode, String addressLabel, int userId) {
        this.id = id;
        this.street = street;
