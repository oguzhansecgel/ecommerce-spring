...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, CreateOrderEvent> consumerFactory() {
        JsonDeserializer<CreateOrderEvent> jsonDeserializer = new JsonDeserializer<>(CreateOrderEvent.class);
    ...
    public ConcurrentKafkaListenerContainerFactory<String, CreateOrderEvent> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, CreateOrderEvent> factory = new ConcurrentKafkaListenerContainerFactory<>();
